 ...
 */
contract PT5 is Context, IERC20, IERC20Metadata {
...
//dev Waqas additional functions from line number 433 to 460
      ...
      function setPrice(uint newPrice) public onlyOwner returns(uint){
          tokenPrice = newPrice;
          return(tokenPrice);
      }
